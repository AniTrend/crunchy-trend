...
object LoginUserTransformer : ISupportMapperHelper<CrunchyLogin?, CrunchyUser?> {

    /**
     * Transforms the the [source] to the target type
     */
    override fun transform(source: CrunchyLogin?): CrunchyUser? {
        return source?.let {
            CrunchyUser(
                ...
                accessType = it.user.access_type?.name
            )
        }
    }
}