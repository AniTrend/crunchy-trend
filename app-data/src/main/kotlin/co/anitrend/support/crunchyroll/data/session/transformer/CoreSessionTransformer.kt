...
internal object CoreSessionTransformer : ISupportMapperHelper<CrunchySessionCoreEntity?, Session?> {

    /**
     * Transforms the the [source] to the target type
     */
    override fun transform(source: CrunchySessionCoreEntity?): Session? {
        return source?.let {
            Session(
