...
object MediaListingTransformer: ISupportMapperHelper<CrunchyRssEpisode, EpisodeFeed> {
     ...
     */
    override fun transform(source: CrunchyRssEpisode): EpisodeFeed {
        return EpisodeFeed(
            id = source.mediaId,
            title = source.title,
    ...
    fun transform(source: CrunchyRssEpisode, locale: Locale, hasPremiumAccess: Boolean): EpisodeFeed {
