...
import co.anitrend.support.crunchyroll.domain.interactors.media.MediaStreamUseCase

class MediaStreamUseCaseImpl(
    ...
    override fun onCleared() {
        (repository as MediaStreamRepository).onCleared()
    }
}