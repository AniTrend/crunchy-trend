...
class CrunchyRssMediaRepository(
    private val useCase: CrunchyRssMediaUseCase
) : SupportRepository<PagedList<CrunchyRssMedia>, CrunchyRssMediaUseCase.Payload>() {
     ...
     */
    override fun invoke(subject: CrunchyRssMediaUseCase.Payload) =
        useCase(
            param = subject
        )
}