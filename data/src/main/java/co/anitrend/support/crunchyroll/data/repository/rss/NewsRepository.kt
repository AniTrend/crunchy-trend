...
import co.anitrend.support.crunchyroll.domain.repositories.rss.INewsRepository

class NewsRepository(
    private val source: NewsSource
) : SupportRepository(source), INewsRepository<UserInterfaceState<PagedList<News>>> {
