...
class CrunchySeriesMapper(
    parentJob: Job,
    private val seriesDao: CrunchySeriesDao
) : CrunchyMapper<CrunchySeries, CrunchySeries>(parentJob) {
     ...
     */
    override suspend fun onResponseMapFrom(source: CrunchySeries): CrunchySeries {
        return source
    }
     ...
     */
    override suspend fun onResponseDatabaseInsert(mappedData: CrunchySeries) {
