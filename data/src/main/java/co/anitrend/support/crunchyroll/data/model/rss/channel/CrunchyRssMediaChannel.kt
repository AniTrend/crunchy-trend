...
package co.anitrend.support.crunchyroll.data.model.rss.channel
...
@Root(strict = false)
data class CrunchyRssMediaChannel(
    ...
    override var item: List<CrunchyRssMedia>? = null
) : ICrunchyRssChannel<CrunchyRssMedia> {
    constructor() : this(
        copyright = "",
        publishedDate = "",
        language = ""
