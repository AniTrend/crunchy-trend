...
class CrunchyMediaListUseCase(
    private val mediaEndpoint: CrunchyMediaEndpoint,
    private val mediaDao: CrunchyMediaDao
) : ISupportCoreUseCase<CrunchyMediaListUseCase.Payload, UiModel<PagedList<CrunchyMedia>>> {
    ...
    override fun invoke(param: Payload): UiModel<PagedList<CrunchyMedia>> {
        val dataSource = CrunchyMediaListDataSource(
