...
import co.anitrend.support.crunchyroll.data.api.endpoint.CrunchyMediaEndpoint
...
class CrunchyMediaStreamRepository(
...
) : SupportRepository<PagedList<CrunchyStreamInfo>>() {
     ...
     */
    override fun invokeRequest(bundle: Bundle): UiModel<PagedList<CrunchyStreamInfo>> {
