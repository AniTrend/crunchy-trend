...
class CrunchyMediaInfoViewModel(
    repository: ISupportRepository<CrunchyMedia?, CrunchyMediaInfoUseCase.Payload>
) : SupportViewModel<CrunchyMedia?, CrunchyMediaInfoUseCase.Payload>(repository)