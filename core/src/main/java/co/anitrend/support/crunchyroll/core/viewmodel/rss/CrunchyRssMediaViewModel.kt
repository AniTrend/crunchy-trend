...
package co.anitrend.support.crunchyroll.core.viewmodel.rss
...
class CrunchyRssMediaViewModel(
    repository: ISupportRepository<PagedList<CrunchyRssMedia>, CrunchyRssMediaUseCase.Payload>
) : SupportViewModel<PagedList<CrunchyRssMedia>, CrunchyRssMediaUseCase.Payload>(repository)