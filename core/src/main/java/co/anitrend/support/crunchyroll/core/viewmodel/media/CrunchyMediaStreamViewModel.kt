...
class CrunchyMediaStreamViewModel(
    repository: ISupportRepository<CrunchyStreamInfo?, CrunchyMediaStreamUseCase.Payload>
) : SupportViewModel<CrunchyStreamInfo?, CrunchyMediaStreamUseCase.Payload>(repository)