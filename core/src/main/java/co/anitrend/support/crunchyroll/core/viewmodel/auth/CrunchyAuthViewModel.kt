...
package co.anitrend.support.crunchyroll.core.viewmodel.auth
...
class CrunchyAuthViewModel(
    repository: ISupportRepository<CrunchyLogin?, CrunchyAuthenticationUseCase.Payload>
) : SupportViewModel<CrunchyLogin?, CrunchyAuthenticationUseCase.Payload>(repository)