...
class CrunchyRssNewsViewModel(
    repository: ISupportRepository<PagedList<CrunchyRssNews>, CrunchyRssNewsUseCase.Payload>
) : SupportViewModel<PagedList<CrunchyRssNews>, CrunchyRssNewsUseCase.Payload>(repository)