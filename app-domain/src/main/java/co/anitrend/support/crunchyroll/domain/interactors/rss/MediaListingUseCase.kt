...
package co.anitrend.support.crunchyroll.domain.interactors.rss
...
abstract class MediaListingUseCase<R: IUserInterfaceState<*>>(
    protected val repository: IMediaListingRepository<R>
